...
object CheckInfo {
    ...
    private val DESCRIPTIONS: Map<String, String> = mapOf(
        ...
        "throughWalls" to "Hit through walls: too many recent hits had no line-of-sight to the victim's body.",
        ...
        "backwardSprint" to "Sprinted backward or strafe-only (impossible in vanilla; needs forward input).",
